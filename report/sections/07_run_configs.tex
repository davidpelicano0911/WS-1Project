...
\begin{enumerate}[leftmargin=*]
  ...
  \item gerar o ficheiro RDF \texttt{rdf/baseball.nt};
...
\begin{itemize}[leftmargin=*]
  ...
  \item importa automaticamente o ficheiro \texttt{rdf/baseball.nt}.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
  ...
  \item \texttt{RDF\_FILE=\$ROOT\_DIR/rdf/baseball.nt}
...
%   \item importar o ficheiro \texttt{rdf/baseball.nt} para esse reposit\'orio.
% \end{enumerate}
% 
...
\begin{itemize}[leftmargin=*]
  ...
  \item o ficheiro \texttt{rdf/baseball.nt} ainda n\~ao ter sido gerado;
