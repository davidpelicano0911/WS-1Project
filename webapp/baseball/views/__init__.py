...
from .players import compare_players_view, graph_view, player_detail_view, player_graph_photo_view, players_view
from .quiz import quiz_answer_api_view, quiz_start_api_view, quiz_state_api_view, quiz_view
from .stats import analytics_view, awards_view, salaries_view, hall_of_fame_view, managers_view
